...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var sliderMain = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_2__["default"]({
    container: '.page',
    btns: '.next'
  });
  sliderMain.render();
  ...
  sliderShowUp.init();
  var sliderModules = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  sliderModules.init();
  var sliderFeed = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  sliderFeed.init();
  var player = new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_3__["default"]('.showup .play', '.overlay');
  player.init();
});
