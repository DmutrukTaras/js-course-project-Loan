...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var sliderMain = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_3__["default"]({
    container: '.page',
    btns: '.next'
  });
  sliderMain.render();
  ...
  new _modules_difference__WEBPACK_IMPORTED_MODULE_1__["default"]('.officerold', '.officer__card-item').init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_1__["default"]('.officernew', '.officer__card-item').init();
  var sliderShowUp = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  sliderFeed.init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_0__["default"]('form').init();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_4__["default"]('.showup .play', '.overlay').init();
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_4__["default"]('.module__video-item .play', '.overlay').init();
});
    ...
    value: function init() {
      ...
      this.form.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusText.textContent = _this.massage.loading;
          statusMassage.appendChild(statusText);
          var formData = new FormData(item);

          _this.postData('assets/question.php', formData).then(function (res) {
            console.log(res);
            statusText.textContent = _this.massage.success;
          }).catch(function () {
            statusMassage.textContent = _this.massage.failure;
          }).finally(function () {
            _this.clearInputs();
...
function (_Slider) {
  ...
  function MainSlider(container, btns, next, prev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, btns, next, prev));
  }
  ...
  _createClass(MainSlider, [{
    ...
    key: "trigerAction",
    value: function trigerAction(triger, n) {
      var _this2 = this;
  ...
  _createClass(miniSlider, [{
    ...
    value: function bindTrigers() {
      ...
      this.prev[0].addEventListener('click', function () {
        for (var index = _this2.slides.length - 1; index > 0; index--) {
          if (_this2.slides[index].tagName != 'BUTTON') {
            var active = _this2.slides[index];
